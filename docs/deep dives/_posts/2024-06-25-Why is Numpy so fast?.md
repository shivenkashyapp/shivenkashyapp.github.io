...
for some operations if they are installed. Benchmarking is a tough subject though, so I'll do extensive benchmarking in the next
    article in this series. There, I'll also compare it to other Linear Algebra APIs, maybe in C/C++. Till then, read more about BLAS and LAPACK with Numpy [here](https://superfastpython.com/what-is-blas-and-lapack-in-numpy/). 
\\
