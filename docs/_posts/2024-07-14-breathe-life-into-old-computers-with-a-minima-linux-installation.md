...
You certainly don't need an RTX 4090 for programming. In fact, you don't need anything more than some integrated graphics<sup>1</sup>, which basically every laptop these days gets shipped with. 
